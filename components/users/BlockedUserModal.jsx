        ...
        <View className="bg-white w-11/12 rounded-2xl p-5 shadow-xl">
          ...
          <View className="mb-4">
            {[1, 2, 3].map((_, idx) => (
              <View
                key={idx}
                className="flex-row items-center p-3 border-b border-gray-100 last:border-0"
              >
                ...
                <View className="flex-row items-center bg-red-50 border border-red-100 px-3 py-1.5 rounded-xl">
