...
export default function TypingIndicator() {
 ...
 <View className="bg-white dark:bg-[#1A1A22] border border-gray-100 dark:border-[#2A2A36] rounded-2xl rounded-bl-md px-4 py-3.5 items-center justify-center flex-row mb-1">
 <Animated.View
