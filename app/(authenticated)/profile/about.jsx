...
export default function About() {
 ...
 <Text className="text-primary dark:text-primary-light text-xl font-extrabold">1.0.0</Text>
 <Text className="text-gray-400 dark:text-gray-500 text-xs mt-1">Version</Text>
 </View>
 <View className="flex-1 bg-white dark:bg-[#1A1A22] rounded-2xl border border-gray-100 dark:border-[#2A2A36] p-4">
 <Text className="text-secondary dark:text-gray-100 text-xl font-extrabold">Expo</Text>
 <Text className="text-gray-400 dark:text-gray-500 text-xs mt-1">Built with</Text>
 </View>
 </View>
