  ...
  const sections = [
    {
      ...
      emptyText: "No rooms created",
      emptyDescription: "Choose a topic and set how long the room stays open.",
    ...
    },
    {
      ...
      emptyText: "No joined rooms",
      emptyDescription: "Browse nearby rooms or join one with an invite code.",
      emptyAction: "Browse rooms",
      emptyRoute: "/home",
    },
  ];
